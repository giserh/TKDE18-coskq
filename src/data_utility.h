...
#define	COSKQ_STAT_FILE			"stat.txt"
#define	COSKQ_RESULT_FILE		"result.txt"
...
typedef struct coskq_config
{
	...
	//CoSKQ specific.
	int		alg_opt;///algorothm indicator
	int		prune_opt;
...
data_t*	read_data_coskq( coskq_config_t* cfg, std::unordered_map<KEY_TYPE, KEY_TYPE>* keywordfreq_hashmap);
